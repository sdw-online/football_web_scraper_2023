...
def log_event_as_debug(logger, message: str):
    logger.debug(message)


def log_event_as_info(logger, message: str):
    logger.info(message)


def log_event_as_warning(logger, message: str):
    logger.warning(message)


def log_event_as_critical(logger, message: str):
    logger.critical(message)


def log_event_as_error(logger, message: str):
